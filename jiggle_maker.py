...
dpi = 100        # Dots per inch - will set the pixel width of the image


dot_rad = 0.5  # How big you want the circles to be plotted

ref_name = 'ref100_stretch'
def_name = 'def100_stretch'
gif_name = 'test100_stretch.gif'
gt_name  = 'gt100_stretch'
...
def deformation_x(x):
    return 1.0101010101*x # stretch in the x
    #return x+1

...
------------------------------------------------------------------------
|   DIGITAL IMAGE CORRELATION: CROSS-CORRELATION COEFF. FIRST ORDER    |
------------------------------------------------------------------------
...
"u" and "v" as well as subset deformations du/dx, dv/dy, du/dy, dv/dx as variables.

This is used when the deformed image is interpolated
%}
